        ...
        { 13, new List<(Vector3[], string[][], int)>()
            {
                ...
                (
                    ...
                    new string[][] {
                        GetRepeatedPattern("P_4", 1),
                        GetRepeatedPattern("P_5", 1),
                        GetRepeatedPattern("P_6", 1),
                        GetRepeatedPattern("P_7", 1),
                        GetRepeatedPattern("P_8", 1),
                        GetRepeatedPattern("P_9", 1),
                        GetRepeatedPattern("P_10", 1),
                        GetRepeatedPattern("P_11", 1),
                        GetRepeatedPattern("P_12", 1),
                        GetRepeatedPattern("P_13", 1),
                        GetRepeatedPattern("P_14", 1),
                        GetRepeatedPattern("P_15", 1),
                    },
                    0
                ),
            }
